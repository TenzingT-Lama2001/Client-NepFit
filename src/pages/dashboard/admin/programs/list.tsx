...
import ProgramTableRow from "../../../../sections/auth/dashboard/program/ProgramTableRow";
import ProgramTableToolbar from "../../../../sections/auth/dashboard/program/ProgramTableToolbar";
...
ProgramList.getLayout = function getLayout(page: React.ReactElement) {
...
export default function ProgramList() {
  ...
  const handleEditRow = (programId: string) => {
    push(PATH_DASHBOARD.dashboard.admin.programs.edit(paramCase(programId)));
  };
  ...
  const deleteProgramMutation = useMutation((id: any) => deleteProgram(id), {
    onSuccess(data) {
  ...
  const {
    ...
    ["get_programs", page, rowsPerPage, filterName, orderBy, order],
    () =>
      getPrograms({
        page,
        limit: rowsPerPage,
    ...
    {
      initialData: { results: [] },
      onSuccess({ programs, totalPrograms }) {
        console.log(programs);
        setTotalCount(totalPrograms);
      ...
      <Container maxWidth="lg">
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: "Programs ", href: PATH_DASHBOARD.dashboard.admin.root },
            { name: "List" },
          ]}
          action={
            <NextLink
              href={PATH_DASHBOARD.dashboard.admin.programs.new}
              passHref
            >
              <Button
                variant="contained"
